...
def before_each_after_each(page: Page, inventory_page: SauceInventoryPage):
...
def test_item_name_in_asc_order(login_page: SauceLoginPage, inventory_page: SauceInventoryPage) -> None:
...
@pytest.mark.regression
def test_item_name_in_desc_order(login_page: SauceLoginPage, inventory_page: SauceInventoryPage) -> None:
    login_page.login_as_user(STANDARD_USER, STANDARD_PASSWORD)
...
@pytest.mark.regression
def test_price_from_low_to_high_order(login_page: SauceLoginPage, inventory_page: SauceInventoryPage) -> None:
    login_page.login_as_user(STANDARD_USER, STANDARD_PASSWORD)
...
@pytest.mark.regression
def test_price_from_high_to_low_order(login_page: SauceLoginPage, inventory_page: SauceInventoryPage) -> None:
    login_page.login_as_user(STANDARD_USER, STANDARD_PASSWORD)
